...
a persistence unit "FarsiRefPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "FarsiRef/pom.xml":
...
artifacts ("FarsiRef-ejb.jar" and "FarsiRef-web.war") are already built. You can build
